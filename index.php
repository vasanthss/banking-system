        ...
        <div class="main-container nav-bg-color">
          <div class="inside-container nav-contain">
            <nav class="navbar navbar-expand-lg navbar-light" >
              <img src="logo.png" class="img-fluid" alt="" style="width:130px;height:130px;">
            ...
            <div class="carousel-item active first-slider">
              <div class="inside-container">
                <div class="row">
                  <div class="col-lg-12  ">
                    <div class="our-text">
                      <h2>Welcome to vasanth Banking System</h2>
                        <div class="butns">
                        <a href="senderdb.php" class="about-btn" role="button">view customers</a>
